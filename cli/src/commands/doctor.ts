...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" fightforge doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `fightforgeai configure --section database` or `fightforgeai onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadFightForgeEnvFile(input.configPath);
