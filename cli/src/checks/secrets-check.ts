...
export function secretsCheck(config: FightForgeConfig, configPath?: string): CheckResult {
  ...
  if (provider !== "local_encrypted") {
    return {
      ...
      canRepair: false,
      repairHint: "Run `fightforgeai configure --section secrets` and set provider to local_encrypted",
    };
  }
