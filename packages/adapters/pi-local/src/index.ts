...
Use when:
- You want FightForge to run Pi (the AI coding agent) locally as the agent runtime
...
- FightForge requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/fightforges/ and resumed with --session.
