...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within FightForgePluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the FightForge host.
 *
...
export interface FightForgePluginManifestV1 {
   ...
   */
  minimumFightForgeVersion?: PluginMinimumHostVersion;
...
export interface PluginRecord {
  ...
  manifestJson: FightForgePluginManifestV1;
