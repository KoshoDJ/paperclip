...
import type { FightForgePluginManifestV1 } from "@fightforgeai/shared";

import type { FightForgePlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@fightforgeai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: FightForgePluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@fightforgeai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
