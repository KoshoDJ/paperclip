/**
 * Bundling presets for FightForge plugins.
 *
 ...
 * to match the FightForge plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@fightforgeai/plugin-sdk/ui",
    "@fightforgeai/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@fightforgeai/plugin-sdk"],
  };
