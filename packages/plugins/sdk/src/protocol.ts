 ...
 * channel.
 *
 * The FightForge plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@fightforgeai/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all FightForge messages.
 */
...
/**
 * FightForge plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this FightForge instance. */
    instanceId: string;
    /** Semver version of the running FightForge host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
