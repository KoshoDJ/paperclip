/**
 * `definePlugin` — the top-level helper for authoring a FightForge plugin.
 *
...
// ---------------------------------------------------------------------------
// FightForgePlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface FightForgePlugin {
 ...
 * @returns A sealed `FightForgePlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@fightforgeai/plugin-sdk";
