/**
 * `@fightforgeai/plugin-sdk/ui` — FightForge plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@fightforgeai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@fightforgeai/plugin-sdk/ui";
 *
