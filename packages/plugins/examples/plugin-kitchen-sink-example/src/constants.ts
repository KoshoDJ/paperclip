import type { PluginLauncherRegistration } from "@fightforgeai/plugin-sdk";

export const PLUGIN_ID = "fightforge-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".fightforge-kitchen-sink-demo.txt",
} as const;
