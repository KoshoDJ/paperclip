...
const manifest: FightForgePluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current FightForge plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "FightForge",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the FightForge domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
