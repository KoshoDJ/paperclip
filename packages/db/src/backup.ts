...
function resolveFightForgeInstanceId(): string {
  const raw = process.env.FIGHTFORGE_INSTANCE_ID?.trim() || "default";
...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolveFightForgeHomeDir(), "instances", resolveFightForgeInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolveFightForgeHomeDir(), "instances", resolveFightForgeInstanceId(), "data", "backups");
}
