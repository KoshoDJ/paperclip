...
This is intentionally separate from the normal FightForge dev image.
...
```sh
review-checkout-pr fightforgeai/fightforge 432
cd /work/checkouts/fightforgeai-fightforge/pr-432
```
...
## Preview the FightForge app from the PR
...
- FightForge's embedded PostgreSQL and local storage stay inside the container home volume via `FIGHTFORGE_HOME=/home/reviewer/.fightforge-review`.
