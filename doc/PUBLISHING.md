...
Low-level reference for how FightForge packages are prepared and published to npm.
...
FightForge no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `fightforgeai`, imports code from workspace packages such as:
...
FightForge uses calendar versions:
...
- `fightforgeai@2026.318.1-canary.2`
