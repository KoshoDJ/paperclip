...
This document covers the GitHub and npm setup required for the current FightForge release model:
...
Do this for every public package that FightForge publishes.
...
3. add a trusted publisher for the GitHub repository `fightforgeai/fightforge`
...
2. revoke any personal automation token that used to publish FightForge
