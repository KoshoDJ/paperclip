...
FightForge already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model FightForge should implement next.

## Product Goals

FightForge should let operators:
...
For the next implementation pass, FightForge should enforce these defaults:
...
FightForge should separate subscription-included usage from billed spend:
...
FightForge should have two threshold classes:
...
FightForge must know that a project is budget-paused and enforce it.
...
FightForge must also block execution before new work starts.
