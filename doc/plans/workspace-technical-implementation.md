...
This document translates [workspace-product-model-and-work-product.md](/Users/dotta/fightforge-subissues/doc/plans/workspace-product-model-and-work-product.md) into an implementation-ready engineering plan.
...
- `local`
  - FightForge may create host-local worktrees, processes, and paths
- `cloud`
  - FightForge should assume no durable host-local execution workspace management
...
- `provider text not null`
  - `fightforge | github | vercel | s3 | custom`
