...
- installed adapter list for this FightForge instance
...
## 8. New Skill: `fightforge-create-agent`

Create new skill directory:

- `skills/fightforge-create-agent/SKILL.md`
- `skills/fightforge-create-agent/references/api-reference.md`
...
Also update `skills/fightforge/SKILL.md` to reference this skill for hiring workflows.
...
- `fightforge-create-agent` skill + docs updates
